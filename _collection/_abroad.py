...
function and its variations. The abroad types are accessed from this module.
...
AbroadValue2 = _extensions.Union[int, float, bool, _extensions.EllipsisType, ReckonType[_T]] # >= 0.3.25 // renamed from SupportsAbroadValue2 (0.3.26b3)
AbroadModifier = _extensions.Union[_extensions.EllipsisType, AbroadValue1[_T], None] # >= 0.3.25 // renamed from SupportsAbroadModifier (0.3.26b3)
...
class _AbroadUnknownInitializer(_extensions.Generic[_T]):
    ...
    def __radd__(self, other: _extensions.Union[_extensions.AVT_Iterable[_T], _extensions.Self]):
        """
        Availability: >= 0.3.32. `other + self`
        """
        if not isinstance(other, (_extensions.Iterable, type(self))):
