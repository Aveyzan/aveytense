...
Constants wrapper for AveyTense. Extracted from former `aveytense.tcs` module
"""
...
SIZE_MAX = (maxsize + 1) * 2 - 1 # 0.3.57
SSIZE_MAX = maxsize # 0.3.57; sys.maxsize

del Decimal, maxsize # not for export
